...
import io.github.andrewpopovdp.altmanager.*;
import io.github.andrewpopovdp.util.ListWidget;
import io.github.andrewpopovdp.util.MultiProcessingUtils;
import io.github.andrewpopovdp.util.json.JsonException;
import io.github.andrewpopovdp.util.json.JsonUtils;
import io.github.andrewpopovdp.util.json.WsonObject;
	...
	private void pressImportAlts()
	{
		try
		{
			Process process = MultiProcessingUtils.startProcessWithIO(
				...
				CmdClient.INSTANCE.getCmdFolder().toString());
